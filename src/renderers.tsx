...
export const ModStyleDivRow = ({ children }: PropsWithChildren) => <div className={styles.rowStyleModule}>{children}</div>;
export const ModStyleDivColumn = () => <div className={styles.colStyleModule} />;
export const InlineSXStyledRow = ({ children }: PropsWithChildren) => <StyledRowWithSx sx={{ ...rowStyle }}>{children}</StyledRowWithSx>;
export const InlineSXStyledColumn = () => <StyledColWithSx sx={{ ...colStyle }} />;
export const InlineStyleBoxRow = ({ children }: PropsWithChildren) => <Box style={{ ...rowStyle }}>{children}</Box>;
export const InlineStyleBoxColumn = () => <Box style={{ ...colStyle }} />;
export const InlineSXBoxRow = ({ children }: PropsWithChildren) => <Box sx={{ ...rowStyle }}>{children}</Box>;
export const InlineSXBoxColumn = () => <Box sx={{ ...colStyle }} />;
export const InlineSXBoxRowStable = ({ children }: PropsWithChildren) => <Box sx={rowStyle}>{children}</Box>;
export const InlineSXBoxColumnStable = () => <Box sx={colStyle} />;
export const StyledRowWithPropsGetterWithStableSx = ({ children }: PropsWithChildren) => <StyledRowWithSx sx={rowStyle}>{children}</StyledRowWithSx>;
export const StyledColumnWithPropsGetterWithStableSx = () => <StyledColWithSx sx={colStyle} />;
export const BaseStyledRowWithPropsGetter = ({ children }: PropsWithChildren) => <StyledRowWithPropsGetter>{children}</StyledRowWithPropsGetter>;
