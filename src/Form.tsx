        ...
        <form onSubmit={onSubmit} style={{ border: '1px solid', padding: 4 }}>
            <fieldset style={{ padding: 0, margin: 0, border: 'none' }}>
                ...
                <div>
                    <label>
                        Row count{' '}
                        <input type="number" name="rows" defaultValue={defaultRowsCount} />
                    </label>
                </div>
                <div>
                    <label>
                        Column count{' '}
                        <input type="number" name="cols" defaultValue={defaultColsCount} />
                    </label>
                </div>
                <div>
                    <label>
                        Iterations{' '}
                        <input type="number" name="iterations" defaultValue={iterations} />
                    </label>
                </div>
                <button type="submit">
                    Submit
